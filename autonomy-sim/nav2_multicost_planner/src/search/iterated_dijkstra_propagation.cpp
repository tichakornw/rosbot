...
// Register this algorithm with the factory
REGISTER_PATHFIND_ALGORITHM("iterated_dijkstra", IteratedDijkstraPropagation);

std::vector<uint32_t> IteratedDijkstraPropagation::getOptimalPath(
...
std::vector<uint32_t> IteratedDijkstraPropagation::getOptimalEdges(
    IMulticostGraph& graph, 
    std::shared_ptr<IMulticostArray> multicostArray, 
    uint32_t start, 
    uint32_t end) 
...
void IteratedDijkstraPropagation::forwardDijkstra(
    OptimalSubgraph& optimalGraph, 
    std::shared_ptr<IMulticostArray> multicostArray, 
    uint32_t source, 
    unsigned int monoidIndex) 
{
...
void IteratedDijkstraPropagation::backwardDijkstra(
    OptimalSubgraph& optimalGraph, 
    std::shared_ptr<IMulticostArray> multicostArray, 
    uint32_t source, 
    unsigned int monoidIndex) 
...
void IteratedDijkstraPropagation::bfsOptimalEdgeRetrieval(
    OptimalSubgraph& optimalSubgraph, 
    std::shared_ptr<IMulticostArray> multicostArray, 
    uint32_t start, 
    unsigned int monoidIndex) 
{
...
void IteratedDijkstraPropagation::iterate(
    OptimalSubgraph& optimalSubgraph, 
    std::shared_ptr<IMulticostArray> multicostArray, 
    uint32_t start, 
    uint32_t end, 
...
OptimalSubgraph IteratedDijkstraPropagation::optimalSubgraph(
    IMulticostGraph& graph, 
    std::shared_ptr<IMulticostArray> multicostArray, 
    uint32_t start, 
    uint32_t end) 
